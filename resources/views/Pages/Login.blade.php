...
<div class="row">
    <div class="col-sm-6 logform">
        <div class="row" style="margin: 20% 0px 0px 20%">
            ...
            <div class="col-sm-6">
                <a class="btn font-weight-medium ml-5 px-5 btnsign" style="color:Black; border :1px solid black;" href="#">Sign Up</a>
            </div>
        </div>
        <div class="formin"  style="margin: 20% 0px 0px 20%" >
            ...
            <form>
                ...
                <p class="mt-3 mb-5">Don't have an account? <span><a style="color:blue" href="#"> Sign up</a><span></p>
            </form>
        </div>
    </div>
